...
- For the game logic write it separately and write unit test along side it (we using vitest, just run pnpm test)
- Always run `typecheck` and fix all issue after finish building.
